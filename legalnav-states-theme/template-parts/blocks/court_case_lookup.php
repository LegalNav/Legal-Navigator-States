<?php //Javascript for the Court Case Lookup Callout.

//Check that a state has been selected.
if(isset($_SESSION['user_state_id'])) {

	//Get State's Term and Api Settings.
	$state_term = get_term_by('id', $_SESSION['user_state_id'], 'states');
	$court_api_settings = get_field('court_api_settings', $state_term);
